<h1 align="center">Hi , I'm Thanush Nethsika <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
<p align="center">
...
- :school: I am a `Undergraduate` at [Faculty of Communication & Business Studies] at [Eastern University](https://www.tc.esn.ac.lk/).
- :trophy: Completed `Full Stack Programming` Course in [University of Moratuwa](https://open.uom.lk/).
- :trophy: Completed `AI/ML` Course in [SLIIT University](https://code.sliit.org/).
- :technologist: I love using Software as a solution for every `Problem`.
- :student: I’m currently learning `Management` , `Full Stack Developing` and `Information Systems`.
